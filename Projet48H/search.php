    ...
    <span class="sr-only">Next</span>
		...
		<table class="table table-bordered table-striped table-hover">
			<tr>
				...
				<th class="text-center">description du produits</th>
...
if ($set) {
	$show =" SELECT * FROM Produits where cat_p = '$set' or cat_p2 ='$set' or cat_p3 = '$set' ";
	...
	while($rows=mysqli_fetch_array($result)){
            ...
            $description_p = $rows['description_p'];
            $description_p2 = $rows['description_p2'];
            $description_p3 = $rows['description_p3'];
            $description_p4= $rows['description_p4'];
            $description_p5= $rows['description_p5'];
            $description_p6= $rows['description_p6'];
            $description_p7 = $rows['description_p7'];
            $description_p8= $rows['description_p8'];
      ...
      <p>Copyright: $description_p7 </p> 
       <p>Date fin d'exploitation: $description_p8 </p> 
				...
				<td class='text-center'>$cat_p, $cat_p2, $cat_p3</td>
				<td class='text-center'><img src='images/$image' style='width:50px; height:50px;'></td>
				<td class='text-center'>
					<span>
					     <a href='#'>
					         <i  style='color:grey;' class='fa fa-pencil' data-toggle='modal' data-target='#edit$id' style='' aria-hidden='true'></i>
					    </a>
					</span>
				...
				<td class='text-center'>
					<span>
						<a href='#'>
						     <i style='color:grey;'  class='fa fa-trash' data-toggle='modal' data-target='#$id' style='' aria-hidden='true'></i>
						</a>
					</span>
    ...
    <select name='cat_p3'  multiple class='form-control' id='exampleFormControlSelect2'>
      ...
      <option>tag5</option>
          ...
          <div class='form-group'>
            ...
            <img src = 'images/$image' style='width:500px; height:500px;'>
          </div>
